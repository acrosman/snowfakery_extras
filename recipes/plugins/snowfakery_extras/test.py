...
import plugins.snowfakery_extras.faker_nonprofit
...
class IntegrationTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fake.add_provider(
            plugins.snowfakery_extras.faker_nonprofit.Provider)
...
class NonProfitProviderTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.provider = plugins.snowfakery_extras.faker_nonprofit.Provider(
            Generator())

    def test_lists_in_order(self):
        """Test interal values are in order."""
        for attr_name, attr in \
                plugins.snowfakery_extras.faker_nonprofit.__dict__.items():
